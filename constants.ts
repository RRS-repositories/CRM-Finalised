...
export const SPEC_LENDERS = [
  ...
  'LIVE LEND',
  'LLOYDS BANK / BANK OF SCOTLAND / MBNA',
  'LLOYDS OVERDRAFT',
  'LOAN4YOU / NA',
  'LOANS 2 GO',
  'LOANS AT HOME',
  ...
  'NAYLORS FINANCE',
  'NEWDAY / OPUS / MARBLES / FLUID / BURTONS',
  'NEXT',
  'NORWICH TRUST',
  'NOVUNA',
  'OCEAN FINANCE',
  ...
  'VANQUIS',
  'VAUXHALL FINANCE',
  'VERY / SHOP DIRECT / G UNIVERSAL',
  'VERY CATALOGUE',
  'VIRGIN/ CLYDESDALE/ YORKSHIRE BANK',
  'WAGE DAY ADVANCES',
  'WAGE STREAM',
  'WAVE',
  'ZABLE',
