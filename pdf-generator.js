...
function buildDocxVariables(contact, caseData, lenderAddress, lenderEmail, signatureBase64 = null) {
    ...
    if (contact.previous_addresses && Array.isArray(contact.previous_addresses) && contact.previous_addresses.length > 0) {
        ...
        const addrParts = [
            firstAddr.address_line_1 || firstAddr.line1,
            firstAddr.address_line_2 || firstAddr.line2,
            firstAddr.city,
            firstAddr.county,
            firstAddr.postal_code || firstAddr.postalCode
        ].filter(Boolean).join(', ');
    ...
    return {
        ...
        client: {
            ...
            previousAddressLine1: contact.previous_addresses?.[0]?.address_line_1 || contact.previous_addresses?.[0]?.line1 || contact.previous_address_line_1 || '',
            previousAddressLine2: contact.previous_addresses?.[0]?.address_line_2 || contact.previous_addresses?.[0]?.line2 || contact.previous_address_line_2 || '',
            ...
            previousPostcode: contact.previous_addresses?.[0]?.postal_code || contact.previous_addresses?.[0]?.postalCode || contact.previous_postal_code || '',
            dateOfBirth: dob,
            dob: dob,
        ...
        clientPreviousAddressLine1: contact.previous_addresses?.[0]?.address_line_1 || contact.previous_addresses?.[0]?.line1 || contact.previous_address_line_1 || '',
        clientPreviousAddressLine2: contact.previous_addresses?.[0]?.address_line_2 || contact.previous_addresses?.[0]?.line2 || contact.previous_address_line_2 || '',
        ...
        clientPreviousPostcode: contact.previous_addresses?.[0]?.postal_code || contact.previous_addresses?.[0]?.postalCode || contact.previous_postal_code || '',
