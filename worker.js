...
const CATEGORY_1_NO_ID_LENDERS = new Set([
    ...
    'FAIR FINANCE', 'FERNOVO', 'FINIO LOANS', 'FINIO/LIKELY LOANS', 'FINTERN/ABOUND', 'FLUID', 'LIKELY LOANS',
    ...
    'PROVIDENT', 'PSA FINANCE', 'QUID MARKET', 'REEVO', "SAINSBURY'S BANK / POST", 'SALAD MONEY', 'SALARY FINANCE',
