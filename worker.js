...
const CATEGORY_1_NO_ID_LENDERS = new Set([
    '118 LOANS', '118 MONEY', '1PLUS 1 LOANS', 'ADMIRAL LOAN', 'ADMIRAL LOANS', 'AMERICAN EXPRESS', 'AQUA', 'ARGOS', 'ASDA',
    'AVANT', 'BANK OF SCOTLAND', 'BARCLAYS / MONUMENT', 'BARCLAYS', 'MONUMENT', 'BARCLAYS CREDIT CARD', 'BARCLAYS OVERDRAFT',
    'BETTER BORROW', 'BIP CREDIT CARD', 'CABOT', 'CAPITAL ONE', 'CAPQUEST/ ARROW', 'CAPQUEST', 'ARROW', 'CAR CASH POINT',
    ...
    'PROVIDENT', 'PSA FINANCE', 'QUID MARKET', 'REEVO', "SAINSBURY'S BANK / POST", "SAINSBURY'S BANK", 'SALAD MONEY', 'SALARY FINANCE',
